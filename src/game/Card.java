...
public class Card extends Rectangle {
	...
	/**
	 * Füllt die Karte mit einem Bild welches zu einem ImagePattern umkonvertiert wird.
	 * 
	 * @param img - Das Image das im Rectangle angezeigt werden soll.
	 * 
	 * WARNUNG: Set fill ist eine recht imperformante Funktion und sollte wenn möglich nicht in einer Gameloop aufgerufen werden.
	...
	/**
	 * @return matched - Ist die Karte bereits mit einer anderen gematched worden - Dann ist sie nicht klickbar / irrelevant fürs 
	 * Spiel
	 */
